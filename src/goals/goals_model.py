...
class Model:
    ...
    def init_from_xlsx(self, xlsx_name):
        ...
        if cfg_opts[CONST.CFG_USE_DIRECT_CLHIV]:
            ...
            self.pmtct = Utils.xlsx_load_pmtct(wb[CONST.XLSX_TAB_PMTCT])
            ...
            self._proj.init_pmtct(self.pmtct['pmtct_n'][year_range,:],
                                  self.pmtct['pmtct_p'][year_range,:],
                                  self.pmtct['retained_before'][year_range],
                                  self.pmtct['retained_during'][year_range],
                                  self.pmtct['retained_postnatal'][year_range,:])
